...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/Linux-armhf/Release/obj/quake2-gles2
  TARGETDIR  = ../../../Output/Targets/Linux-armhf/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles2
  DEFINES   += -DARCH=\"arm\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES2 $(TOUCH_OVERLAY_DEFINE)
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/Linux-armhf/Debug/obj/quake2-gles2
