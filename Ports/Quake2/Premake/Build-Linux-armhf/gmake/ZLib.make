...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/Linux-armhf/Release/obj/ZLib
  TARGETDIR  = ../../../Output/Targets/Linux-armhf/Release/lib
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/Linux-armhf/Release/lib -s
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/Linux-armhf/Debug/obj/ZLib
  TARGETDIR  = ../../../Output/Targets/Linux-armhf/Debug/lib
  TARGET     = $(TARGETDIR)/libZLib.a
  DEFINES   +=
  INCLUDES  += -I../../../../../Engine/External/include -I../../../../../Engine/External/Sources/zlib
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/Linux-armhf/Debug/lib
  LDDEPS    +=
  LIBS      += $(LDDEPS)
  LINKCMD    = $(AR) -rcs $(TARGET) $(OBJECTS)
  define PREBUILDCMDS
