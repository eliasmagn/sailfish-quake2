...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/Linux-armhf/Release/obj/quake2-rogue
  TARGETDIR  = ../../../Output/Targets/Linux-armhf/Release/bin/rogue
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/Linux-armhf/Debug/obj/quake2-rogue
  TARGETDIR  = ../../../Output/Targets/Linux-armhf/Debug/bin/rogue
  TARGET     = $(TARGETDIR)/game.so
  DEFINES   += -DARCH=\"arm\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP
  INCLUDES  += -I../../../../../Engine/External/include -I../../../Sources -I../../../Sources/rogue/src
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
