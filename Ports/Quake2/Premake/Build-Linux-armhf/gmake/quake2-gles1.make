...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/Linux-armhf/Release/obj/quake2-gles1
  TARGETDIR  = ../../../Output/Targets/Linux-armhf/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles1
  DEFINES   += -DARCH=\"arm\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES1 $(TOUCH_OVERLAY_DEFINE)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/Linux-armhf/Release/lib -L. -s
  LDDEPS    += ../../../Output/Targets/Linux-armhf/Release/lib/libZLib.a
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/Linux-armhf/Debug/obj/quake2-gles1
  TARGETDIR  = ../../../Output/Targets/Linux-armhf/Debug/bin
  TARGET     = $(TARGETDIR)/quake2-gles1
  DEFINES   += -DARCH=\"arm\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES1 $(TOUCH_OVERLAY_DEFINE)
  INCLUDES  += -I../../../../../Engine/External/include -I../../../Sources -I../../../../../Engine/Sources/Compatibility -I../../../../../Engine/Sources/Compatibility/OpenGLES/Includes
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/Linux-armhf/Debug/lib -L.
  LDDEPS    += ../../../Output/Targets/Linux-armhf/Debug/lib/libZLib.a
  LIBS      += $(LDDEPS) -lm -ldl -lGLESv1_CM -lEGL -lSDL2 
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
